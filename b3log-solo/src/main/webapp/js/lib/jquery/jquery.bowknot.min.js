 ...
 * limitations under the License.
 */
// version 0.0.0.8; 上一页、下一页、首页、末页的自定义
(function ($) {
    $.fn.extend({
        paginate: {
            version: "0.0.0.8",
        ...
        _build: function (target) {
            ...
            if (pages[0] !== 1) {
                if (settings.previousPage) {
                    ...
                    + "' onclick=\"$.paginate._changePages('" + id + "', '" + (currentPage - 1) + "');" + bindEvent
                    + "(" + (currentPage - 1) + ");\">" + settings.previousPage + "</span>" + paginationHTML;
                }
                if (settings.firstPage) {
                    paginationHTML = "<span title='1' class='"+ styleClass.firstPageClass + "' onclick=\"$.paginate._changePages('"
                    + id + "', '1');" + bindEvent
            ...
            if (pages[pages.length - 1] !== pageCount) {
                ...
                if (settings.lastPage) {
                    ...
                    + "' onclick=\"$.paginate._changePages('" + id + "', '" + pageCount + "');" + bindEvent
...
(function ($) {
    ...
    $.extend(Completed.prototype, {
        ...
        _init: function (target) {
            ...
            var $panel = $("#" + id + "Panel");
            $panel.width($it.width() - $.bowknot.strToInt($panel.css("padding-top"))
                - $.bowknot.strToInt($panel.css("padding-bottom")));
