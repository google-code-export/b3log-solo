        ...
        _popTip: function (event) {
            ...
            if (matchData.length > 0) {
                if (event.keyCode === 38) {
                    ...
                    currentStringArray.push(matchData[settings.currentNum]);
                ...
                this.value = currentStringArray.toString();
