...
import org.b3log.solo.repository.impl.CSDNBlogArticleSoloArticleGAERepository;
...
public final class RepositoryModule extends AbstractServiceModule {
    ...
    protected void configure() {
        ...
        bind(CSDNBlogArticleSoloArticleRepository.class).to(
                CSDNBlogArticleSoloArticleGAERepository.class).in(
                Scopes.SINGLETON);
    }
}
