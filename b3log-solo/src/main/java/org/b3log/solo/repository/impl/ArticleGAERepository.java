...
public class ArticleGAERepository extends AbstractGAERepository
    ...
    /**
     * Updates a certain article by the specified article id and the specified
     * new article.
     *
     * <p>
     *   Update algorithm steps:
     *   <ol>
     *     <li>Finds the old article by the article id stored in database</li>
     *     O(n)
     ...
     */
    @Override
    public void update(final String articleId, final JSONObject newArticle)
            throws RepositoryException {
        try {
            LOGGER.debug("Updating an article[oId=" + articleId + "]");
            // Step 1, 2:
            remove(articleId);
            // Step 3:
