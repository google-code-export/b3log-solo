        ...
        <script type="text/javascript">
            ...
            var addComment = function (result, state) {
                ...
                commentHTML += '<div class="right">' + result.commentDate
                    ...
                    + '<div class="comment-content">' + articleUtil.replaceCommentsEmString($("#comment" + state).val().replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\n/g,"<br/>"))
                    + '</div><div class="clear"></div></div></div><div class="comment-bottom"></div></div></div>';
