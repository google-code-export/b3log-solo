...
(function ($) {
    ...
    $.extend(Table.prototype, {
        ...
        _buildTableBody: function (target, num) {
            ...
            checkedArray = [],
            styleClass = $.table._getDefaults($.table._defaults, settings, "styleClass");
            var bodyHTML = "<table style='width:100%;' cellpadding='0' cellspacing='0'>",
            data = [],
            currentDataNum = 0;
            data = settings.data;
                ...
                for (var tempIndex in elements) {
                    ...
                    for (var index in elements) {
                        if(colModelIndex === index && colModel[j].visible === undefined) {
                            ...
                            if (colModel[j].inputType === "order") {
                                var orderHTML = "";
                                if (i === 0 && data.length > 1) {
                                    orderHTML = "&nbsp;<span>down</span>";
                                } else if (i < data.length - 1) {
                                    orderHTML = "<span>up</span>&nbsp;<span>down</span>";
                                } else if (i === 0 && data.length === 1){
                                    
                                } else {
                                    orderHTML = "<span>up</span>";
                                }
                                dataElement = orderHTML;
                            }
                    ...
                    for (var j = 0; j < data.length; j++) {
                        ...
                        for (var k = 0; k < colModel[i].bindEvent.length; k++) {
                            bindElement.bind(colModel[i].bindEvent[k].eventName,
                                keys, colModel[i].bindEvent[k].action);
                        }
                    }
                }
            }
