...
(function ($) {
    ...
    $.extend(Tabs.prototype, {
        ...
        _addTabs: function (target, addData) {
            ...
            $src.after("<li><div id='" + id + "_" + addData.id + "'>\
                            <a href='#" + addData.id + "'>" + addData.text + "</a>\
                        </div></li>");
            $("#" + id + "_" + addData.id).click(function () {
                         $.tabs._setCurrentTab(this, target);
                    });
            $("#" + id + "Panel").append("<div id=" + id + "Panel_" + addData.id + ">" + addData.content + "</div>");
        }, 
